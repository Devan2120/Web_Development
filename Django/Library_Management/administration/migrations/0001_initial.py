# Generated by Django 4.2.1 on 2024-08-02 13:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='book',
            constraint=models.CheckConstraint(check=models.Q(('rel_date__lte', datetime.date(2024, 8, 2))), name='Release Date', violation_error_message='Invalid Release Date'),
        ),
        migrations.AddField(
            model_name='login',
            name='groups',
